  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link href="/dashboard/contacts" className="bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-6 text-white hover:shadow-lg transition">
        ...
        <Link href="/dashboard/analytics" className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl p-6 text-white hover:shadow-lg transition">
          <div className="text-2xl mb-2">📈</div>
        ...
        <Link href="/dashboard/devices" className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl p-6 text-white hover:shadow-lg transition">
          <div className="text-2xl mb-2">📱</div>
